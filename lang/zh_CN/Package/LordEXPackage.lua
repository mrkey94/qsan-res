...
return {
	...
	["weimeng"] = "Ngụy Minh",
	[":weimeng"] = "Một lần trong giai đoạn hành động, bạn có thể chọn 1 người khác có bài, bạn thu lấy tối đa X lá của họ (X là số máu của bạn), sau đó giao lượng bài tương đương cho họ. Bạn có thể lệnh họ nhận kỹ năng \"Ngụy Minh (Tung Hoành)\" (Thay mô tả X thành 1) cho đến khi kết thúc lượt tiếp theo của họ.",
	...
	["designer:xuyou"] = "QSanguosha Team",
	["designer:xiahouba"] = "QSanguosha Team",
	["designer:zhugeke"] = "QSanguosha Team",
	["designer:sunchen"] = "QSanguosha Team",
	["designer:panjun"] = "QSanguosha Team",
	["designer:wenqin"] = "QSanguosha Team",
	["designer:huangzu"] = "QSanguosha Team",
	["designer:gongsunyuan"] = "QSanguosha Team",
	["designer:pengyang"] = "QSanguosha Team",
