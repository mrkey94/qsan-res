...
Mode2v2v2v2_rule = sgs.CreateTriggerSkill{
	name = "Mode2v2v2v2",
	...
	on_effect = function(self, evnet, room, player, data,ask_who)
		...
		room:setTag("Mode2v2v2v2_UsedGeneral",sgs.QVariant(table.concat(used,"+")))
...
Mode2v2v2v2 = {
	name = "Mode2v2v2v2_hegemony",
	expose_role = false,
	player_count = 8,
	random_seat = true,
	rule = Mode2v2v2v2_rule,
	on_assign = function(self, room)
		...
		for i = 1,8,1 do --开始给每名玩家分配待选择的武将。
			...
			local random_general = getRandomGenerals(4,kingdoms[i],selected)
		...
		for i = 1,8,1 do --依次设置genera1、general2。
			...
			room:setTag("Mode2v2v2v2_UsedGeneral",sgs.QVariant(table.concat(used,"+"))) --记录使用过的武将。
		end
		return generals, generals2,kingdoms
	end,
}
sgs.LoadTranslationTable{
	["Mode2v2v2v2_hegemony"] = "2v2v2v2",
}
return sgs.CreateLuaScenario(Mode2v2v2v2)